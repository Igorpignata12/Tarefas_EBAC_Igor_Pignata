package br.com.ipignata.dao.generics;
...
public abstract class GenericDAO<T, E extends Serializable> implements IGenericDAO<T,E> {
        ...
        for (Field field : fields) {
            if (field.isAnnotationPresent(TipoChave.class)) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    throw new TipoChaveNaoEncontradaException("Chave principal do objeto " + entity.getClass() + " não encontrada", (Throwable) e);
                }
            }
        }
        if (returnValue == null) {
    ...
    public abstract void atualizarDados(Persistente entity, Persistente entityCadastrado);
}